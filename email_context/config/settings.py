...
if os.path.exists(env_file):
    ...
    logging.getLogger('root').log(logging.WARNING, f"ENVIRONMENT {os.getenv('ENVIRONMENT')} SELECTED!")
else:
    logging.getLogger('root').log(logging.ERROR, f"ENVIRONMENT FILE NOT FOUND!")
